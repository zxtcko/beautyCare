...
class ConfirmingReservationViewController: UITableViewController {
    ...
    let ReservationDetailIndetifier = "ConfirmingDetailTableViewController"
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        let reservationDetail = UIStoryboard.mainStoryboard.instantiateViewControllerWithIdentifier(ReservationDetailIndetifier) as! ReservationDetailViewController
        
        reservationDetail.reservationID = self.reserveInfoArray[indexPath.row].id!
